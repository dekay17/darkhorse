...
@implementation MKMapView(Lavahound)
...
- (BoundingCoordinates *)boundingCoordinates {
    ...
    MKMapPoint northEastMapPoint = MKMapPointMake(visibleMapRect.origin.x + visibleMapRect.size.width, visibleMapRect.origin.y);
    MKMapPoint southWestMapPoint = MKMapPointMake(visibleMapRect.origin.x, visibleMapRect.origin.y + visibleMapRect.size.height);
    return [[[BoundingCoordinates alloc] initWithSouthWestCoordinate:MKCoordinateForMapPoint(southWestMapPoint) northEastCoordinate: MKCoordinateForMapPoint(northEastMapPoint)] autorelease];
}
